...
from backend.models.models import CUConnection, Course, User
...
def get_matrix(creator, course, size=None, semester="V21"):
    for elements in CUConnection.objects(creator=creator, course=course):
